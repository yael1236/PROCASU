            ...
            <div class="row d-flex">
                <div class="col-5 p-5 ">
                    ...
                    <div class="form-group">
                        <div class="card " style="width: 22rem; margin-right: 5rem; height: 320px; background-color: var(--procasu1);">
                ...
                <div class="col-md-6 d-flex">
                    <form class="mx-2 my-5">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="nombreColaboradores">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="sector" class="form-label">Sector</label>
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="sector">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="principales">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="contacto" class="form-label">Nombre del contacto</label>
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="contacto">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="numcontacto">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="numempresa">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="responsable">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="direcgen" class="form-label">Nombre del director general</label>
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="direcgen">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="emaildirecgen">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="add" class="form-label">Contacto adicional (opcional)</label>
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="add">
